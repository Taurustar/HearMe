...
namespace sdkMapControlWP8CS
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        public static Location lugarGlobal {get; set;}
        private Location location = new Location();
        private List<Location> Lugares;
                       ...
                       if (globito == true)
                        {
                            ...
                            Pines pin = new Pines(myCanvas, lugar,this);
        ...
        public void goToReproducir(object sender, System.Windows.Input.GestureEventArgs e)
        {
       ...
       /* void ToggleLandmarks(object sender, EventArgs e)
        ...
        private void locationToSoundData(Location location)
        {
            ...
            soundData.Title = location.Title;
            ...
            soundData.FilePath = location.FilePath;
